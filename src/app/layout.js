  ...
  return (
    <html lang="en">
      <body className="bg-dark text-white relative antialiased min-h-screen">
        ...
        <SpeedInsights />
        <Analytics />
        <div className="  border-beam !fixed -right-1 bottom-[8vh] md:bottom-[33vh] z-50 hidde w-fit rounded-l-2xl border border-white/10 bg-black/75 p-3 backdrop-blur md:block ">
